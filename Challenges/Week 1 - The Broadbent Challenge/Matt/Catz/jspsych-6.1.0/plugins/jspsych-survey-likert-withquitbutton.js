...
jsPsych.plugins['survey-likert-withquitbutton'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'survey-likert-withquitbutton',
    description: '',
    parameters: {
      questions: {
      ...
      quit_button: {
        type: jsPsych.plugins.parameterType.BOOL,
        pretty_name: 'give participant quit button',
        default:  true,
        description: 'quit button or nay?'
      }
    }
  }
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add submit button
    html += '<div><input type="submit" id="jspsych-survey-likert-next" class="jspsych-survey-likert jspsych-btn" value="'+trial.button_label+'"></input></div>';

    // and add quit button
    if (trial.quit_button){
      html += '<div><br><br><input type="quit" id="jspsych-survey-likert-quit" class="jspsych-survey-likert jspsych-btn" value="Quit"></input></div>';
    }
    ...
    display_element.querySelector('#jspsych-survey-likert-quit').addEventListener('click', function(){
      display_element.innerHTML = '';
