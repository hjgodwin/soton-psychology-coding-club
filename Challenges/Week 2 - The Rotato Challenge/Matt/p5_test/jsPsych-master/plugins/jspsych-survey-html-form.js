...
jsPsych.plugins['survey-html-form'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var html = '<div style="background-color: white; width:800px; font-size:80%; padding:5%;">';

    // add soton logo to top of form
    html += "<img src= 'university-of-southampton-vector-logo.png' style='margin: auto; width: 35%; height: 35%;'></img>";
    ...
    // add submit button
    html += '<input disabled type="submit" id="jspsych-survey-html-form-next" class="jspsych-btn jspsych-survey-html-form" value="'+trial.button_label+'"></input>';

    html += '</form>';
    html += '</div>';
    display_element.innerHTML = html;

    display_element.querySelector('#consent-checkbox').addEventListener('change', function(){
      if (this.checked){
