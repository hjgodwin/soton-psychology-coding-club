  ...
  module.autoPreload = function(timeline, callback, images, audio, video, progress_bar) {
    ...
    function update_loading_progress_bar(){
      ...
      if(progress_bar){
        ...
        var pbar = jsPsych.getDisplayElement().querySelector('#jspsych-loading-progress-bar');
        if (pbar){
          pbar.style.width = percent_loaded+"%"; // deals with problem of somehow detecting a null progress bar
        }
      }
    }
